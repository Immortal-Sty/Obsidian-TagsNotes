...
var sortedFiles = derived(
  [sort, files],
  ([$sort, $files]) => [...$files].sort((a, b) => b.stat[$sort] - a.stat[$sort])
);
...
function add_css(target) {
  append_styles(target, "svelte-lppoti", ".card.svelte-lppoti.svelte-lppoti{position:absolute;background-color:var(--background-primary-alt);border:1px solid var(--background-modifier-border);padding:var(--card-padding);word-wrap:break-word;overflow-y:hidden;margin:0;transition-property:transform;transition-duration:0.4s}.card.skip-transition.svelte-lppoti.svelte-lppoti{transition:none}.card.svelte-lppoti.svelte-lppoti{font-size:0.8rem}.card.svelte-lppoti p,.card.svelte-lppoti ul{margin:0.3rem 0}.card.svelte-lppoti h1,.card.svelte-lppoti h2,.card.svelte-lppoti h3{margin:0 0 0.3rem}.card.svelte-lppoti ul{padding-left:var(--size-4-5)}.card.svelte-lppoti.svelte-lppoti:hover{border-color:var(--background-modifier-border-hover)}.card.svelte-lppoti h3.svelte-lppoti{word-wrap:break-word}.card.svelte-lppoti .card-info.svelte-lppoti{margin:calc(-1 * var(--card-padding));margin-top:0;border-top:1px solid var(--background-modifier-border);padding:var(--size-4-1) var(--card-padding);background-color:var(--background-primary);display:flex;flex-direction:row;align-items:center;justify-content:end;gap:var(--size-4-1)}.card.svelte-lppoti .card-info .folder-name.svelte-lppoti{flex-grow:1}");
}
function create_if_block(ctx) {
  ...
  return {
    c() {
      ...
      span1 = element("span");
      t = text(t_value);
      attr(span1, "class", "folder-name svelte-lppoti");
    },
    m(target, anchor) {
...
function create_fragment(ctx) {
  ...
  return {
    c() {
      ...
      attr(h3, "class", "svelte-lppoti");
      attr(button, "class", "clickable-icon");
      attr(div1, "class", "card-info svelte-lppoti");
      attr(div2, "class", "card svelte-lppoti");
      attr(div2, "role", "link");
...
function instance2($$self, $$props, $$invalidate) {
  ...
  let $searchQuery;
  let $displayedFiles;
  component_subscribe($$self, skipNextTransition, ($$value) => $$invalidate(18, $skipNextTransition = $$value));
  component_subscribe($$self, viewIsVisible, ($$value) => $$invalidate(19, $viewIsVisible = $$value));
  component_subscribe($$self, sort, ($$value) => $$invalidate(20, $sort = $$value));
  component_subscribe($$self, searchQuery, ($$value) => $$invalidate(21, $searchQuery = $$value));
  ...
  async onOpen() {
    ...
    this.app.workspace.on("active-leaf-change", () => {
      ...
      store_default.viewIsVisible.set(
        ((_a = rootLeaf == null ? void 0 : rootLeaf.view) == null ? void 0 : _a.getViewType()) === VIEW_TYPE
      );
    });
  }
  async onClose() {
