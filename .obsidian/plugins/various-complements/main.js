...
var VariousComplementsSettingTab = class extends import_obsidian6.PluginSettingTab {
  ...
  async addMainSettings(containerEl) {
    ...
    new import_obsidian6.Setting(containerEl).setName("策略").addDropdown(
    ...
    new import_obsidian6.Setting(containerEl).setName("匹配策略").addDropdown(
    ...
    if (this.plugin.settings.matchStrategy === MatchStrategy.PARTIAL.name) {
      containerEl.createEl("div", {
        text: "\u26A0 `部分`比`前缀`策略要慢10倍以上",
        cls: "various-complements__settings__warning"
      });
    }
    new import_obsidian6.Setting(containerEl).setName("模糊匹配").addToggle((tc) => {
      tc.setValue(this.plugin.settings.fuzzyMatch).onChange(async (value) => {
        this.plugin.settings.fuzzyMatch = value;
        await this.plugin.saveSettings();
      });
    });
    new import_obsidian6.Setting(containerEl).setName("最小模糊匹配分值").setDesc(
      "它只显示模糊匹配得分大于特定值的提示。"
    ).addSlider(
    ...
    new import_obsidian6.Setting(containerEl).setName("将重音变音符号视为字母字符。").setDesc("例：如果启用，'aaa' 将匹配为 '\xE1\xE4\u0101'").addToggle((tc) => {
      tc.setValue(
    ...
    new import_obsidian6.Setting(containerEl).setName("不带表情符号的匹配").setDesc("例：如果启用， 'aaa' 将匹配为 '\u{1F600}aaa'").addToggle((tc) => {
    ...
    new import_obsidian6.Setting(containerEl).setName("最大提示数").addSlider(
    ...
    new import_obsidian6.Setting(containerEl).setName("单条短语的最大字数").setDesc(`[\u26A0警告] 使速度减慢 N 倍以上(N 为设定值)`).addSlider(
    ...
    new import_obsidian6.Setting(containerEl).setName("触发的最少字符数").setDesc(
      "将值设置为0并不意味着将没有任何输入提示。相反，将根据您选择的策略使用一个指定的值。"
    ).addSlider(
    ...
    new import_obsidian6.Setting(containerEl).setName("触发的最少单词数").addSlider(
    ...
    new import_obsidian6.Setting(containerEl).setName("自动补全").addToggle((tc) => {
    ...
    new import_obsidian6.Setting(containerEl).setName("延迟N毫秒后触发").addSlider(
    ...
    new import_obsidian6.Setting(containerEl).setName("启用「输入法期间禁用提示」").addToggle((tc) => {
      tc.setValue(
    ...
    new import_obsidian6.Setting(containerEl).setName("完成后插入空格").addToggle((tc) => {
    ...
    new import_obsidian6.Setting(containerEl).setName("禁用建议的第一个字符").addText((cb) => {
      cb.setValue(
    ...
    new import_obsidian6.Setting(containerEl).setName("抑制触发器的文本样式").setDesc(
      "正则表达式行模式（部分匹配）直到光标，以抑制自动完成的激活。可以用换行符来定义多个模式。"
    ).addTextArea((tc) => {
    ...
    new import_obsidian6.Setting(containerEl).setName("抑制触发器的短语模式").setDesc(
      "抑制自动完成式激活的正则表达式模式（完全匹配）。可以用换行符来定义多个模式。"
    ).addTextArea((tc) => {
    ...
    new import_obsidian6.Setting(containerEl).setName("在循环之前没有自动对焦功能").setDesc("在按下循环键之前，不要将焦点放在提示上。").addToggle((tc) => {
  ...
  addAppearanceSettings(containerEl) {
    ...
    new import_obsidian6.Setting(containerEl).setName("显示匹配策略").setDesc(
      "在状态栏上显示匹配策略。更改此选项需要重新启动才能生效。"
    ).addToggle((tc) => {
    ...
    new import_obsidian6.Setting(containerEl).setName("自动显示补全").setDesc(
      "在状态栏上自动显示补充功能。更改此选项需要重新启动才能生效。"
    ).addToggle((tc) => {
    ...
    new import_obsidian6.Setting(containerEl).setName("显示索引状态").setDesc(
      "在状态栏上显示索引状态。更改此选项需要重新启动才能生效。"
    ).addToggle((tc) => {
    ...
    new import_obsidian6.Setting(containerEl).setName("对提示词条的描述").addDropdown(
      (tc) => tc.addOptions(
  ...
  addKeyCustomizationSettings(containerEl) {
    ...
    li.append(
      ...
      "看到自定义热键。 (按任意键以显示 'event.key')"
    );
    const ul = createEl("ul");
    ul.createEl("li", {
      text: "'Ctrl a' 表示按下 Ctrl 键和 A 键。"
    });
    ul.createEl("li", {
      text: "'Enter|Tab' 表示按下 Enter 键或 Tab 键。"
    });
    ul.createEl("li", {
      text: "使用 'Mod' 代表windows系统的 'Ctrl' 键或macOS系统的 'Cmd' 键。"
    });
    ul.append(li);
    const df = document.createDocumentFragment();
    df.append(ul);
    new import_obsidian6.Setting(div).setHeading().setName("热键").setDesc(df);
    ...
    new import_obsidian6.Setting(containerEl).setName("使用 ESC 键").setDesc(
      "如果你使用Vim模式，这是很方便的，因为你可以通过一个ESC切换到正常模式，无论它是否显示提示。"
    ).addToggle((tc) => {
  ...
  addCurrentFileComplementSettings(containerEl) {
    ...
    new import_obsidian6.Setting(containerEl).setName("启用「补全当前文件提示」").addToggle((tc) => {
    ...
    if (this.plugin.settings.enableCurrentFileComplement) {
      new import_obsidian6.Setting(containerEl).setName("索引的最小字符数").setDesc("如果设置为0，则使用「策略」的默认值。").addSlider(
      ...
      new import_obsidian6.Setting(containerEl).setName("在当前文件时只显示英文提示").addToggle((tc) => {
        tc.setValue(
  ...
  addCurrentVaultComplementSettings(containerEl) {
    ...
    new import_obsidian6.Setting(containerEl).setName("启用「补全当前库内容提示」").addToggle((tc) => {
    ...
    if (this.plugin.settings.enableCurrentVaultComplement) {
      ...
      new import_obsidian6.Setting(containerEl).setName("包括前缀路径模式").setDesc("前缀匹配路径模式以包括文件。").addTextArea((tac) => {
      ...
      new import_obsidian6.Setting(containerEl).setName("排除前缀路径模式").setDesc("前缀匹配路径模式以排除文件。").addTextArea((tac) => {
        const el = tac.setValue(
      ...
      new import_obsidian6.Setting(containerEl).setName("只包括当前目录下的文件").addToggle((tc) => {
        tc.setValue(
  ...
  addCustomDictionaryComplementSettings(containerEl) {
    ...
    new import_obsidian6.Setting(containerEl).setName("启用「自定义补全提示字典」").addToggle((tc) => {
      tc.setValue(
    ...
    if (this.plugin.settings.enableCustomDictionaryComplement) {
      new import_obsidian6.Setting(containerEl).setName("自定义字典路径").setDesc(
        "为每一行指定一个来自库根目录或URL的相对路径。"
      ).addTextArea((tac) => {
      ...
      new import_obsidian6.Setting(containerEl).setName("列分隔符").addDropdown(
      ...
      new import_obsidian6.Setting(containerEl).setName("单词正则表达式模式").setDesc("只加载与正则表达式模式匹配的单词。").addText((cb) => {
        cb.setValue(
      ...
      new import_obsidian6.Setting(containerEl).setName("隐藏提示的分隔符").setDesc(
        "如果设置为 ;;; 符号，则 abcd;;;efg 会在提示中显示 abcd，而把 abcdefg 做为补全内容。"
      ).addText((cb) => {
      ...
      new import_obsidian6.Setting(containerEl).setName(
        ...
        "如果设置为 ' >>> ', '显示内容 >>> 插入内容' 会在提示中显示 '显示内容' ，但实际上屏 '插入内容' 。"
      ).addText((cb) => {
        cb.setValue(
      ...
      new import_obsidian6.Setting(containerEl).setName("指定「补全后插入光标符的语法」").setDesc(
        "如果设置为 '<CARET>' 并且在自定义字典指定 '<li><CARET></li>' 样式, 则在输入 '<li></li>' 后会移动光标到达 '<li>' 和 `</li>` 之间。"
      ).addText((cb) => {
        cb.setValue(
      ...
      new import_obsidian6.Setting(containerEl).setName("显示的文本后缀").setDesc(
        "如果显示文本和插入文本之间存在差异，则显示为显示文本的后缀"
      ).addText((cb) => {
  ...
  addInternalLinkComplementSettings(containerEl) {
    ...
    new import_obsidian6.Setting(containerEl).setName("启用「补全内部链接」").addToggle((tc) => {
    ...
    if (this.plugin.settings.enableInternalLinkComplement) {
      new import_obsidian6.Setting(containerEl).setName("提示使用别名").addToggle((tc) => {
        tc.setValue(
      ...
      new import_obsidian6.Setting(containerEl).setName("保存时更新内部链接").addToggle((tc) => {
      ...
      if (this.plugin.settings.insertAliasTransformedFromDisplayedInternalLink.enabled) {
        new import_obsidian6.Setting(containerEl).setName("之前: 带捕获的正则表达式模式").setDesc(String.raw`Ex: (?<name>.+) \(.+\)$`).setClass("various-complements__settings__nested").addText((cb) => {
          cb.setValue(
        ...
        new import_obsidian6.Setting(containerEl).setName("之后").setDesc("例：$<name>").setClass("various-complements__settings__nested").addText((cb) => {
          cb.setValue(
      ...
      new import_obsidian6.Setting(containerEl).setName("用于排除的前置关键字").setDesc(
        "如果其前端事务的键名称与此设置相同，并且该值为 'true'，则请从建议中排除内部链接"
      ).addText((cb) => {
        TextComponentEvent.onChange(cb, async (value) => {
  ...
  addFrontMatterComplementSettings(containerEl) {
    ...
    new import_obsidian6.Setting(containerEl).setName("启用补全 YMAL 前置内容").addToggle((tc) => {
    ...
    if (this.plugin.settings.enableFrontMatterComplement) {
      new import_obsidian6.Setting(containerEl).setName("YAML 前置内容的匹配策略").addDropdown(
        (tc) => tc.addOptions(
      ...
      new import_obsidian6.Setting(containerEl).setName("在完成后插入逗号").addToggle((tc) => {
        tc.setValue(
  ...
  addIntelligentSuggestionPrioritizationSettings(containerEl) {
    ...
    new import_obsidian6.Setting(containerEl).setName("启用智能提示的优先级排序").addToggle((tc) => {
      tc.setValue(
    ...
    if (this.plugin.settings.intelligentSuggestionPrioritization.enabled) {
      new import_obsidian6.Setting(containerEl).setName("历史记录文件路径").setDesc(`默认：${DEFAULT_HISTORIES_PATH}`).addText((cb) => {
        TextComponentEvent.onChange(cb, async (value) => {
      ...
      new import_obsidian6.Setting(containerEl).setName("保存历史记录的最大天数").setDesc("如果设置为0，则永远不会删除").addSlider(
      ...
      new import_obsidian6.Setting(containerEl).setName("要保留的最大历史记录数").setDesc("如果设置为0，则永远不会删除").addSlider(
  ...
  addMobileSettings(containerEl) {
    ...
    new import_obsidian6.Setting(containerEl).setName("在移动设备上禁用").addToggle((tc) => {
  ...
  addDebugSettings(containerEl) {
    ...
    new import_obsidian6.Setting(containerEl).setName("在控制台中显示性能日志").addToggle((tc) => {
      tc.setValue(
  ...
  async onload() {
    ...
    this.addCommand({
      ...
      callback: async () => {
        ...
        new import_obsidian8.Notice("复制 Various Complements 的设置参数");
      }
    });
  }
  async loadSettings() {
