  ...
  constructor() {
    ...
    this.viewUpdatePlugin = (update) => {
      ...
      tr.changes.iterChanges((fromA, toA, fromB, toB, inserted) => {
        ...
        if (changeType == "EasyTyping.change")
          return;
