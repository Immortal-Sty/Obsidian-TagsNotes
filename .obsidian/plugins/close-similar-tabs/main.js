...
function openLinkWrapper(plugin) {
  const openLinkPatched = around(import_obsidian.Workspace.prototype, {
    openLinkText(old) {
...
var CSTSettingsTab = class extends import_obsidian3.PluginSettingTab {
...
var CST = class extends import_obsidian4.Plugin {
  ...
  getVisibleLeaf() {
    var _a;
    return (_a = this.app.workspace.getActiveViewOfType(import_obsidian4.View)) == null ? void 0 : _a.leaf;
  }
  getActiveFileView() {
    var _a;
    return (_a = this.app.workspace.getActiveViewOfType(import_obsidian4.View)) == null ? void 0 : _a.leaf;
