  ...
  const openLinkPatched = around(import_obsidian2.Workspace.prototype, {
    openLinkText(old) {
      return async function(...args) {
        ...
        if (
          // ok // to same page
          (path.basename(sourcePath, path.extname(sourcePath)) === getFirstPartOfWikiLink(linktext) || linktext.trim().startsWith("#")) && newLeaf !== "tab" && !plugin.ctrl && OpenViewState === void 0
        ) {
          ...
          if ((activeLeaf == null ? void 0 : activeLeaf.getDisplayText()) === "Files") {
            ...
            Console.log("activeLeaf", activeLeaf == null ? void 0 : activeLeaf.getDisplayText());
          }
...
function getDupli(plugin, linktext, sourcePath, activeLeaf) {
  ...
  const openFilePatched = around(import_obsidian3.WorkspaceLeaf.prototype, {
    ...
    openFile(old) {
      return async function(...args) {
        ...
        } else if ((state == null ? void 0 : state.active) === true || (state == null ? void 0 : state.eState)) {
...
var CST = class extends import_obsidian5.Plugin {
  ...
  getVisibleLeaf() {
    var _a;
    return ((_a = this.app.workspace.getActiveViewOfType(import_obsidian5.View)) == null ? void 0 : _a.leaf) || null;
  }
  getActiveFileView() {
    var _a;
    return ((_a = this.app.workspace.getActiveViewOfType(import_obsidian5.View)) == null ? void 0 : _a.leaf) || null;
